...
@Component({
  ...
  template: `
    <div class="page">
      ...
      <div class="cat-banner" style="background:#e65100">
        <div class="banner-overlay" style="background:#e65100"></div>
        <h1>Sapatos</h1>
      ...
      <div *ngIf="!carregando && items.length > 0" class="items-grid">
        <app-produto-card *ngFor="let item of items" [peca]="item" categoria="sapatos" emoji="👟" (adquirido)="mostrarToast($event)" />
      </div>
