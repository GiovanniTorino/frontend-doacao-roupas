...
@Component({
  ...
  template: `
    <div class="page">
      ...
      <div class="cat-banner" style="background:#43a047">
        <div class="banner-overlay" style="background:#43a047"></div>
        <h1>Camisas</h1>
      ...
      <div *ngIf="!carregando && items.length > 0" class="items-grid">
        <app-produto-card *ngFor="let item of items" [peca]="item" categoria="camisas" emoji="👕" (adquirido)="mostrarToast($event)" />
      </div>
